...
fetch("https://webmosaic.petrichor.events/post?id=3")
    .then(res => res.json())
...
fetch("https://webmosaic.petrichor.events/post?id=5")
    .then(res => res.json())
...
fetch("https://webmosaic.petrichor.events/author?id=2")
    .then(res => res.json())
    .then(data =>document.getElementById("z5").innerHTML = "-by " +data.name
            )


fetch("https://webmosaic.petrichor.events/post?id=6")
    .then(res => res.json())
...
fetch("https://webmosaic.petrichor.events/author?id=3")
    .then(res => res.json())
